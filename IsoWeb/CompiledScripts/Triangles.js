	...
	draw: function(_context) {
		...
		if (ss.isNullOrUndefined(this.element)) {
			if (this.pointUp) {
				...
				xxx += 7;
				yyy += 15;
				var mf = _context.path('M' + xxx + ' ' + yyy + 'L' + (xxx + 15) + ' ' + (yyy + 30) + 'L' + (xxx - 15) + ' ' + (yyy + 30) + 'L' + xxx + ' ' + yyy);
				mf.attr({ 'stroke-width': 5, stroke: 'white', 'stroke-opacity': 0.150000005960464, fill: 'white', 'fill-opacity': 0.150000005960464 });
			}
			else {
				var x1 = (this.x - 1) / 2;
				var y1 = this.y;
				...
				xxx1 += 15;
				yyy1 += 15;
				var mf1 = _context.path('M' + xxx1 + ' ' + yyy1 + 'L' + (xxx1 + 30) + ' ' + yyy1 + 'L' + (xxx1 + 15) + ' ' + (yyy1 + 30) + 'L' + xxx1 + ' ' + yyy1);
				mf1.attr({ 'stroke-width': 5, stroke: 'white', 'stroke-opacity': 0.150000005960464, fill: 'white', 'fill-opacity': 0.150000005960464 });
			}
