...
namespace Isos
{
    ...
    public class RaphaelPaper
    {
        ...
        public void Clear() {}
        public RaphaelElement Circle(float x, float y, float radius)
        {
            return null;
        }
        public RaphaelElement Ellipse(float x, float y, float rx, float ry) { return null; }
    ...
    [IgnoreNamespace]
    [Imported(IsRealType = true)]
    public class RaphaelPaperSet:RaphaelElement
    { 
        public void Push(  RaphaelElement elements) { }
        public void Clear() {}
