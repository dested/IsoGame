function Main() {
        ...
        switch (_e.which) {
            case 1:
                for (l = 0; l < allTriangles.length; l++) {
                    allTriangles[l].selected = allTriangles[l].neighbors = false;
    ...
    function drawBoard() {
        ...
        for (l = 0; l < specials.length; l++) {//drawing happens sequentially, and it will draw over our highlight, so we draw those last.
            specials[l].draw(ctx);
        }
